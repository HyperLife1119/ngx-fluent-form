...
`},"./stories/fluent-form/basic/simple/index.story.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,default:()=>index_story,simple:()=>simple});var react=__webpack_require__("./node_modules/react/index.js"),esm=__webpack_require__("./node_modules/@storybook/addon-docs/dist/esm/index.js"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),dist_esm=__webpack_require__("./node_modules/@mdx-js/react/dist/esm.js"),fluent_form=__webpack_require__("./stories/fluent-form/index.ts"),src=__webpack_require__("./projects/ngx-fluent-form/src/index.ts");var storybook=__webpack_require__("./stories/storybook.ts"),ts_dedent_esm=__webpack_require__("./node_modules/ts-dedent/esm/index.js");const story=(0,storybook.LS)({args:{schemas:(0,src.cr)((0,src.qH)("text").label({value:"文本输入框",tooltip:"小贴士"}).span(24).id("ipt"),(0,src.J7)("textarea").label("文本框").span(24),(0,src.Rx)("number").label("数字输入框").span(24),(0,src.hT)("date").label("日期录入框").span(24),(0,src.w6)("range").label("区间日期录入框").span(24),(0,src.t2)("datetime").label("日期时间录入框").span(24),(0,src.XV)("time").label("时间录入框").span(24),(0,src.Wy)("switch").label("开关").placeholder(["启用","禁用"]).value(!0).span(24),(0,src.k0)("radio").label("单选框组").options([{label:"女",value:"女"},{label:"男",value:"男"}]).span(24),(0,src.MJ)("checkbox").label("单个复选框").content("同意").span(24),(0,src.ub)("checkboxGroup").label("复选框组").options([{label:"唱跳",value:"唱跳"},{label:"Rap",value:"Rap"},{label:"篮球",value:"篮球"}]).span(24),(0,src.Ys)("select").label("选择器").options([{label:"Jack",value:"jack"},{label:"Lucy",value:"lucy"},{label:"Disabled",value:"disabled",disabled:!0}]).span(24),(0,src.Ln)("cascader").label("联级选择器").options([{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake",isLeaf:!0}]},{value:"ningbo",label:"Ningbo",isLeaf:!0}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men",isLeaf:!0}]}]}]).span(24),(0,src.rW)("rate").label("评分").value(2.5).span(24),(0,src.$i)("slider").label("滑动条").value(30).span(24),(0,src.LI)().subtype("primary").content("普通按钮"),(0,src.LI)().subtype("primary").content("带图标的按钮").icon("check"),(0,src.LI)().content("危险按钮").danger(!0),(0,src.DN)().schemas((0,src.LI)().subtype("primary").content("确认"),(0,src.LI)().content("取消"),(0,src.LI)().content("看不见我").hidden((()=>!0)),(0,src.LI)().content("动态").hidden((model=>model.slider<50)))),model:{}}}),source=ts_dedent_esm.default`
...
//# sourceMappingURL=fluent-form-basic-simple-index-story-mdx.6d9eeaf0.iframe.bundle.js.map